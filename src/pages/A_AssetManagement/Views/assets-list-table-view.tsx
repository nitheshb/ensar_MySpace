...
import AssetTableFiltersResult from './assets-table-filters-result';
import AssetTableHeadCustom from './asset-table-head-custom';
...
export default function AssetsListTableView() {
