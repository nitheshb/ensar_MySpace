...
//     { title: t('Learning'), path: paths.dashboard.general.ecommerce, icon: ICONS.blog },
//     { title: t('Asset Management'), path: paths.dashboard.general.analytics, icon: ICONS.job },
//     { title: t('Sprints'), path: paths.dashboard.kanban, icon: ICONS.kanban },
//     { title: t('HR'), path: paths.dashboard.general.banking, icon: ICONS.user },
//   ],
// },
// ----------------------------------------------------------------------
    ...
    () => [
      ...
      // ----------------------------------------------------------------------
      {
        ...
        items: [
          { title: t('Home'), path: paths.dashboard.root, icon: ICONS.dashboard },
          { title: t('Learning'), path: paths.dashboard.general.ecommerce, icon: ICONS.blog },
          { title: t('Assets'), path: paths.dashboard.general.analytics, icon: ICONS.job },
          { title: t('Assets'), path: paths.dashboard.general.assets, icon: ICONS.job },
          { title: t('Sprints'), path: paths.dashboard.kanban, icon: ICONS.kanban },
          // { title: t('HR'), path: paths.dashboard.general.banking, icon: ICONS.user },
        ],
      },
        ...
        items: [
          // USER
          {
            ...
            children: [
              ...
              { title: t('Employees'), path: paths.dashboard.user.empList },
              { title: t('Add Employee'), path: paths.dashboard.user.new },
              { title: t('edit'), path: paths.dashboard.user.demo.edit },
              { title: t('Emp account'), path: paths.dashboard.user.account },
            ],
          },
